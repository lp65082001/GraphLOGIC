...
real_posl = np.array(["G12","P11","P10","G9","P8","P7","G6","P5","P4","G3","P2","P1","*G0","P1'","P2'","G3'","P4'","P5'","G6'","P7'","P8'","G9'","P10'","P11'","G12'","P13'","P14'"])
...
plt.plot((a1_feature[0,:,0]+a1_feature[0,:,1]+a1_feature[1,:,0]+a1_feature[1,:,1])/283, lw=1, color='lightcoral', linestyle='solid',label="$ɑ_1$")
#plt.plot(a1_feature[0,:,1], lw=1, color='cornflowerblue', linestyle='solid',label="Lethal ($ɑ_1$)")
plt.plot((a1_feature[0,:,2]+a1_feature[1,:,2])/283, lw=1, color='seagreen', linestyle='solid',label="$ɑ_2$")

plt.plot(12,0,"r*",label="mutation position")
plt.legend(edgecolor="black",fontsize=12)
plt.xticks(range(27),real_posl ,fontsize=10,rotation=90)
plt.ylabel("normalized quantity (283)",fontsize=12)
...
plt.plot((a1_feature[2,:,0]+a1_feature[2,:,1]+a1_feature[3,:,0]+a1_feature[3,:,1])/269, lw=1, color='lightcoral', linestyle='solid',label="$ɑ_1$")
#plt.plot(a1_feature[0,:,1], lw=1, color='cornflowerblue', linestyle='solid',label="Lethal ($ɑ_1$)")
plt.plot((a1_feature[2,:,2]+a1_feature[3,:,2])/269, lw=1, color='seagreen', linestyle='solid',label="$ɑ_2$")
plt.plot(12,0,"r*",label="mutation position")
plt.legend(edgecolor="black",fontsize=12)
plt.xticks(range(27),real_posl ,fontsize=10,rotation=90)
plt.ylabel("normalized quantity (269)",fontsize=12)
plt.xlabel("amino acid position",fontsize=12)
plt.yticks(fontsize=12)
plt.ylim(0,1)
#plt.ylim(0,0.5)
