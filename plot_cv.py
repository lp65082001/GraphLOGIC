...
plt.xticks([1,2],[f"$α_{1}$ benchmark",f"$α_{1}$$_{2}$ benchmark"],fontsize=12,rotation=30)
...
plt.xlim(0,3)
plt.ylabel("accuracy",fontsize=14)
plt.xticks([1,2],[f"GraphLOGIC\n($α_{1}$ training set)",f"Bodian et al"],fontsize=12,rotation=30)
plt.title("validation (10-fold avg)",fontsize=14)
